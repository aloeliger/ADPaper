...
config.General.requestName = f'AnomalyDetectionPaper2025_ZPrimeToTauTau_Winter24_CERN_{today}'
...
config.Data.outputDatasetTag = f'AnomalyDetectionPaper2025_ZPrimeToTauTau_Winter24_CERN_{today}'
