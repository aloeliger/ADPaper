...
process.cicadaEmulationTask = cms.Task(
    ...
    process.cicadav2p1p2UnpackedEmulation,
    process.cicadav2p2p0UnpackedEmulation,
)
...
process.cicada2024UnpackedTable = cms.EDProducer(
    'CICADATableProducer',
    cicadaSrc = cms.InputTag('cicadav2p1p2UnpackedEmulation', 'CICADAScore'),
    cicadaName = cms.string('CICADA2024_Unpacked'),
)
process.cicada2025UnpackedTable = cms.EDProducer(
    'CICADATableProducer',
    cicadaSrc = cms.InputTag('cicadav2p2p0UnpackedEmulation', 'CICADAScore'),
    cicadaName = cms.string('CICADA2025_Unpacked'),
)
process.cicadaUnpackedTable = cms.EDProducer(
    'CICADATableProducer',
    cicadaSrc = cms.InputTag('gtStage2Digis', 'CICADAScore'),
    cicadaName = cms.string('CICADAUnpacked')
)
process.cicadaTableTask = cms.Task(
    process.cicada2024Table,
    process.cicada2025Table,
    process.cicada2024UnpackedTable,
    process.cicada2025UnpackedTable,
    process.cicadaUnpackedTable,
)
