...
config.General.requestName = f'Operations_ZeroBias_Run2025C_Run392991_{today}'
...
config.Data.runRange='392991'
config.Data.publication=False
config.Data.outputDatasetTag = f'Operations_ZeroBias_Run2025C_Run392991_{today}'
