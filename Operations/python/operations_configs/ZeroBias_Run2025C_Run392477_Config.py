...
config.General.requestName = f'Operations_ZeroBias_Run2025C_Run392477_{today}'
...
config.Data.runRange='392477'
config.Data.publication=False
config.Data.outputDatasetTag = f'Operations_ZeroBias_Run2025C_Run392477_{today}'
